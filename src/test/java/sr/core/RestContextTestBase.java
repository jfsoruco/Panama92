...
import sr.core.service.TransactionService;

/**
 * Test class for UserModuleController API's. Allows to load ALL Spring CONTEXT
 * so is like the application with all beans configured for Spring
 * available(DataSource, JDBCTemplate, Controllers..)
 * 
 * <pre>
 ...
 * 
 * spring-database-embedded-test.xml: This xml defines tests with In Memory Database (H2) Faster tests
 * spring-database-test.xml: This xml defines tests with real SQL Server Database (real time/compatibility tests)
 * </pre>
 * 
 * @author juan.soruco
 *
...
@ContextConfiguration({ "file:src/main/webapp/WEB-INF/mvc-dispatcher-servlet.xml",
	//"file:src/main/webapp/WEB-INF/spring-database-test.xml"
	"file:src/main/webapp/WEB-INF/spring-database-embedded-test.xml"
	// , "file:src/main/webapp/WEB-INF/spring-security.xml"
})
@WebAppConfiguration
public class RestContextTestBase {
